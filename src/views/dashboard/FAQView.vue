...
const faqs = ref([
  ...
  },
  {
    ...
    answer: `
      <p class="text-gray-600 leading-relaxed pb-4">
        <strong>SHCUnion (Smile Hug Care Union)</strong> adalah platform layanan digital untuk berbagai kebutuhan.
      </p>`,
  },
  {
    question: "Bagaimana cara menjadi volunteer?",
      ...
      >
        ...
        >
          ...
          <div
            ...
            "
          >
            <p v-html="faq.answer" class="text-gray-600 leading-relaxed pb-4">
            </p>
          </div>
        </div>
      </div>
